...
import KhMyPagination from "./KhMyPagination";
    ...
    const qnaList = async () => {
      ...
      datas.forEach((item, index) => {
        ...
        const obj = {
          ...
          qna_secret: JSON.parse(item.QNA_SECRET), //"false"->false가 된다
          file: item.FILE_NAME,
          comment: item.COMM_NO,
        };
        list.push(obj);
      });
      //데이터셋에 변화에 따라 리렌더링 할 것과 기존에 DOM을 그냥 출력하는 것
    ...
    <>
      ...
      <ContainerDiv>
        ...
        <FormDiv>
          ...
          >
            <KhMyPagination page={page} path={"/qna/list"} />
            <SearchBar />
          </div>
        </FormDiv>
      </ContainerDiv>
